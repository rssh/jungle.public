...
/**
 * Pseude-oentiy for 'Intersect' persister
 */
@javax.persistence.Entity
@org.hibernate.annotations.Entity(mutable=false)
@org.hibernate.annotations.Persister(impl=RiIntersectPersister.class)
...
public class RiIntersect implements Serializable, RiFakeEntity
{
 ...
 @EmbeddedId
    ...
    public RiIntersect createEmpty()
    {
      return new RiIntersect();
    }
